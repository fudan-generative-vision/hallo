...
from hallo.utils.util import (
    delete_additional_ckpt,
    import_filename, init_output_dir, load_checkpoint, compute_snr, save_checkpoint,
...
def log_validation(
    ...
    for idx in range(len(cfg.ref_img_path)):
        ref_img_path = cfg.ref_img_path[idx]
